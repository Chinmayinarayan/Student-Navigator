/**
 * seedDaaCoding.js
 * Seeds CodingProblem documents for all Design and Analysis of Algorithms topics.
 * Run with: node server/seed/seedDaaCoding.js
 */
...
const codingData = require("../data/subjects/daaCodingPractice");

async function seed() {
  await mongoose.connect(process.env.MONGODB_URI);
  console.log("Connected to MongoDB");

  // Find Design and Analysis of Algorithms subject
  const subject = await Subject.findOne({ name: /^design and analysis of algorithms$/i });
  if (!subject) {
    console.error("Design and Analysis of Algorithms subject not found");
    process.exit(1);
  }
