/**
 * seedDsaCoding.js
 * Seeds CodingProblem documents for all Data Structures and Algorithms topics.
 * Run with: node server/seed/seedDsaCoding.js
 */
...
const codingData = require("../data/subjects/dsaCodingPractice");
...
async function seed() {
  ...
  const subject = await Subject.findOne({ name: /^data structures and algorithms$/i });
  if (!subject) {
    console.error("Data Structures and Algorithms subject not found");
    process.exit(1);
  }
