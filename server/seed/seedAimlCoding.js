/**
 * seedAimlCoding.js
 * Seeds CodingProblem documents for all Artificial Intelligence & Machine Learning topics.
 * Run with: node server/seed/seedAimlCoding.js
 */
...
const codingData = require("../data/subjects/aimlCodingPractice");
...
async function seed() {
  ...
  // Find AI / ML subject
  const subject = await Subject.findOne({ name: /artificial intelligence/i });
  if (!subject) {
    console.error("Artificial Intelligence and Machine Learning subject not found");
    process.exit(1);
  }
