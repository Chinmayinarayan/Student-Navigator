...
const updateCOASubject = async () => {
  try {
    ...
    const topicDocsToInsert = coaTopics.map(t => ({
    ...
    for (const rawTopic of coaTopics) {
    ...
    console.log("✅ Computer Organization and Architecture update completed successfully!");
    process.exit(0);
  } catch (error) {
